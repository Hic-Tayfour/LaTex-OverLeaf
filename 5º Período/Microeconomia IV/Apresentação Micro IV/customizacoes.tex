...
\setbeamertemplate{background}{
    \includegraphics[width=\paperwidth,height=\paperheight]{Apresentação Micro IV/bakcground.png}
}
...
\setbeamertemplate{background}{
    \parbox[c][\paperheight][c]{\paperwidth}{
        \vfill
        \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{Apresentação Micro IV/bakcground.png} 
        \vfill
    }
}
...
% Definir o estilo de item com um quadrado verde
